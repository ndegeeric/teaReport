            ...
            <tbody>
                {
                    bodyData?.map((item,i) => (
                      <tr className='w-full even:bg-blue-100 px-3' key={item._id}>
                        <td className='text-right py-1 px-1.5' >{i+1}</td>
                        <td className='text-right py-1 px-1.5'>{dateFormatter(item.createdAt)}</td>
                        <td className='text-right py-1 px-1.5'>{item.weight}</td>
